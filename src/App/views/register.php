    ...
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <?php if (array_key_exists('age', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['age'] as $value) {
                        echo $value;
                    } ?>
                </div>
            <?php endif ?>
        ...
        <label class="block">
            ...
            <?php if (array_key_exists('country', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['country'] as $value) {
                        echo $value;
                    } ?>
                </div>
            <?php endif ?>
        ...
        <label class="block">
            ...
            <?php if (array_key_exists('socialMediaURL', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['socialMediaURL'] as $value) {
                        echo $value;
                    } ?>
                </div>
            <?php endif ?>
        ...
        <label class="block">
            ...
            <?php if (array_key_exists('confirmPassword', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['confirmPassword'] as $value) {
                        echo $value;
                    } ?>
                </div>
            <?php endif ?>
